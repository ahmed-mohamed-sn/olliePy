...
@pytest.mark.parametrize("numerical_feature_name, new_feature_name, number_of_bins, suffix", [
    (3, 'Y', 5, 'test'),
    (3, 'Y', 5, None),
    ('X', False, 5, None),
    ('X', 'Y', '5', None),
...
@pytest.mark.parametrize("numerical_feature_name, new_feature_name", [
    ('X3', 'Test'),
    ('X', '')
])
...
def test_create_dashboard_with_binned_feature(complex_dashboard_for_binned_features):
    expected_output = {'title': 'Test dashboard title',
                       'datasets': ['test', 'test_2'],
                       'numericalColumns': ['generated_id', 'A', 'G', 'H', 'I'],
                       'categoricalColumns': ['B', 'C', 'D', 'E', 'A_binned'],
                       'dateColumns': ['F'],
                       'test': [{'A': 1,
                                 'B': 'Category_1',
                                 'C': 'Category_1',
    ...
    complex_dashboard_for_binned_features.bin_numerical_feature('A', 'A_binned', 2, 'test')
